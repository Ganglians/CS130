// Name: Juan Chavez Transformations Lab
// Quarter, Year: 
// Lab: 5
//
...
void GLrender()
{
	...
	glTranslatef(90*cos(elapsed/15), 0, -90*sin(elapsed/15));
	glRotatef(3, 0, 0, 1);
	glColor4f(1, 0, 0, 1);
	glutSolidSphere(10, 100, 100);
	
	//glPushMatrix();
	glTranslatef(9*cos(elapsed), 10*cos(elapsed), -20*sin(elapsed));
	glColor4f(1, 1, 1, 1);
	glutSolidSphere(3, 90, 90);
